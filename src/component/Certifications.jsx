...
const Certifications = () => {
  ...
  return (
    <section id="certifications" className="py-20 px-4 sm:px-6 lg:px-8 bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          <div className="bg-[#111111] border border-[#333333] rounded-xl p-6 text-center hover:shadow-[0_0_25px_rgba(130,103,236,0.15)] transition-all duration-300 hover:border-[#8267ec] group">
            ...
            <div className="text-3xl font-bold text-white mb-1">{certifications.length}</div>
            <div className="text-gray-300 text-sm font-medium">Total Certifications</div>
          </div>
          ...
          <div className="bg-[#111111] border border-[#333333] rounded-xl p-6 text-center hover:shadow-[0_0_25px_rgba(130,103,236,0.15)] transition-all duration-300 hover:border-[#8267ec] group">
            ...
            <div className="text-gray-300 text-sm font-medium">AI & Data Science</div>
          </div>
          ...
          <div className="bg-[#111111] border border-[#333333] rounded-xl p-6 text-center hover:shadow-[0_0_25px_rgba(130,103,236,0.15)] transition-all duration-300 hover:border-[#8267ec] group">
            ...
            <div className="text-gray-300 text-sm font-medium">Web Development</div>
          </div>
          ...
          <div className="bg-[#111111] border border-[#333333] rounded-xl p-6 text-center hover:shadow-[0_0_25px_rgba(130,103,236,0.15)] transition-all duration-300 hover:border-[#8267ec] group">
            ...
            <div className="text-gray-300 text-sm font-medium">Verified</div>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          >
            {duplicatedCertifications.map((cert, index) => (
              <div
                key={index}
                className="flex-shrink-0 w-[320px] bg-[#111111] border border-[#333333] rounded-xl overflow-hidden hover:shadow-[0_0_30px_rgba(130,103,236,0.25)] transition-all duration-500 group hover:border-[#8267ec] hover:-translate-y-2"
              >
                ...
                <div className={`bg-gradient-to-br ${cert.color} p-4 relative overflow-hidden`}>
                  ...
                  <div className="relative z-10 flex items-center justify-between mb-3">
                    ...
                    <div className="bg-white/20 backdrop-blur-sm px-2 py-1 rounded-full">
                      <span className="text-white text-xs font-semibold">{cert.category}</span>
                    </div>
                  </div>
                  
                  <div className="relative z-10 flex items-center">
                    <MdVerified className="text-white text-lg mr-2" />
                    <span className="text-white text-xs font-medium">{cert.verified ? 'Verified Certificate' : 'Certificate'}</span>
                  </div>
                </div>

                {/* Card Body */}
                <div className="p-4">
                  <h3 className="text-white font-bold text-base mb-2 leading-tight min-h-[48px] group-hover:text-[#8267ec] transition-colors">
                    {cert.name}
                  </h3>
                  ...
                  <div className="mb-3">
                    <div className="flex items-center justify-between text-xs text-gray-300 mb-2">
                      <div className="flex items-center space-x-1">
                        <div className="w-1 h-1 bg-[#8267ec] rounded-full"></div>
                  ...
                  <div className="pt-3 border-t border-[#333333]">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        <FaShieldAlt className="text-[#8267ec] text-xs" />
                      ...
                      <a
                        ...
                        className="flex items-center space-x-2 bg-[#8267ec] text-white px-3 py-1.5 rounded-lg hover:bg-white hover:text-black border border-transparent hover:border-black transition-all duration-300 group/button hover:shadow-[0_0_15px_rgba(130,103,236,0.4)]"
                ...
                {/* Hover Effect Border */}
                <div className="absolute inset-0 border-2 border-transparent group-hover:border-[#8267ec] rounded-xl pointer-events-none transition-all duration-500"></div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-black border border-[#8267ec] rounded-2xl p-6 max-w-2xl mx-auto hover:shadow-[0_0_40px_rgba(130,103,236,0.25)] transition-all duration-300 group">
